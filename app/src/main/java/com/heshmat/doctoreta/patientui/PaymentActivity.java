                        ...
                        new ApiResultCallback<Source>() {
                            ...
                            public void onSuccess(@NonNull Source source) {
                                try {
                                    ...
                                    Task<HashMap<String, Object>> s = FirebaseFunction.sendPayemnt(sourceModelMap);
                                            ...
                                            loadingDialog.dismissDialog();
                                                    for(String key:stringObjectHashMap.keySet()){
                                                        if (Objects.equals(stringObjectHashMap.get(key), "SUCCESSFUL")){
                                                            ...
                                                            Reservation doctorReservation= new DoctorReservation(getReservationDate,StaticFields.RESERVATION_STATUS_WAITING
                                                                    ,getReservationHour,User.currentLoggedUser.getId(),User.currentLoggedUser.getName()
                                                                    );
                                                            addBooking(StaticFields.DOCTORS,getDoctorId,doctorReservation);
                                                            Reservation patientReservation= new PatientReservation(getReservationDate,StaticFields.RESERVATION_STATUS_WAITING
                                                                    ,getReservationHour,getDoctorId,getDoctorName,getDoctorEmail,getPrice
                                                            );
